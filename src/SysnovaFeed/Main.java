              ...
              if(findVersion == false){
                  try{
                        ...
                        boolean isUpdated = sqlManager.updateDatabase();
                            if(isUpdated){
                                JOptionPane.showMessageDialog(null, "Database Update Successfull", "Update Successfully", JOptionPane.INFORMATION_MESSAGE);
                            }else{
                                JOptionPane.showMessageDialog(null, "Database Update Failed", "Failed", JOptionPane.INFORMATION_MESSAGE);
                            }
